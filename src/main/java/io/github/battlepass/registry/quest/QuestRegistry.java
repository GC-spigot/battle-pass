...
public interface QuestRegistry extends Registry {
     ...
     */
    boolean hook(String name, Instantiator<ExternalQuestExecutor> instantiator, String author, Predicate<Double> versionPredicate);


    /**
     * Same as {@link QuestRegistry#hook(String, Instantiator, String, Predicate)} but without the author check.
     */
    default void hook(String name, Instantiator<ExternalQuestExecutor> instantiator, Predicate<Double> versionPredicate) {
